...
class LLMTemplate:
    def __init__(self, operators, experiment_description=None,
                 output_format=None, instruction=None,
        ...
        self.previous_evaluations = previous_evaluations if (
                previous_evaluations is not None) else (
